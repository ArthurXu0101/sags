...
@dataclass
class SemanticDataparserOutput(DataparserOutputs):
...
class SemanticDataParser(DataParser):
    ...
    def __init__(self, config: SemanticDataParserConfig):
    ...
    def _generate_dataparser_outputs(self, split: str = "train", **kwargs):
        ...
        dataparser_outputs = SemanticDataparserOutput(
